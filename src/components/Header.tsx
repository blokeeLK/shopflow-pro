        ...
        <div className="container flex items-center justify-between h-14 md:h-16">
          ...
          <nav className="hidden md:flex items-center gap-10">
            ...
            <Link to="/atacado" className="relative group">
              ...
              <span className="flex items-center gap-1.5 bg-[#25d366] text-white text-[12px] font-bold px-4 py-2 rounded-full tracking-[0.15em] uppercase shadow-md transition-all duration-300 hover:scale-105 hover:shadow-[0_0_16px_rgba(37,211,102,0.4)] animate-[atacado-pulse_8s_ease-in-out_infinite]">
                📦 ATACADO
              </span>
            </Link>
          </nav>
